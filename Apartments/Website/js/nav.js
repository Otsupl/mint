...
$(document).ready(function()
{
  ...
  function scrollTo(event)
  {
    ...
    setTimeout(function(){$("#navcontainer li").css({'pointer-events': 'none'})}, 2000);
    setTimeout(function(){$("#navcontainer li").css({'pointer-events': ''})}, 2100);
...
function onScrollNav()
{
  ...
  if(scrollTop < $('#about').offset().top - vhx50)
    {$('#navcontainer .active').removeClass('active'); $('#dot_home').addClass('active');}
  else if(scrollTop < $('#whyus').offset().top - vhx50)
    {$('#navcontainer .active').removeClass('active'); $('#dot_about').addClass('active');}
  else if(scrollTop < $('#photos').offset().top - vhx50)
    {$('#navcontainer .active').removeClass('active'); $('#dot_whyus').addClass('active');}
  else if(scrollTop < $('#contact').offset().top - vhx50)
    {$('#navcontainer .active').removeClass('active'); $('#dot_photos').addClass('active');}
  else
    {$('#navcontainer .active').removeClass('active'); $('#dot_contact').addClass('active');}
}